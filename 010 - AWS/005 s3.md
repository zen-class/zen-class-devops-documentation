...
An object consists of data, key (assigned name), and metadata. A bucket is used to store objects. When data is added to a bucket, Amazon S3 creates a unique version ID and allocates it to the objects


<img src="https://github.com/Gitscooby/Images/blob/main/aws%20s3%20image%201.png">
